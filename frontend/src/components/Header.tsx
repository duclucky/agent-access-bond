  ...
  return (
    <header className="lg:hidden fixed top-0 left-0 w-full z-50 flex justify-between items-center px-4 h-16 border-b border-slate-800 bg-slate-950/95 backdrop-blur-md">
      <div className="flex items-center gap-2 cursor-pointer" onClick={() => onNavigate('dashboard')}>
        ...
        <span className="font-headline font-black text-base text-white tracking-tighter uppercase">AgentAccessBond</span>
      </div>
      ...
      <div className="flex items-center gap-2">
        ...
        <button
          ...
          className="bg-orange-500 text-slate-950 font-mono text-xs px-3 py-1.5 rounded-xl hover:bg-orange-400 font-bold uppercase tracking-wider flex items-center gap-1.5 shadow-sm"
        >
